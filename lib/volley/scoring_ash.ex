defmodule Volley.ScoringAsh do
  use Ash.Domain

  resources do
    resource Volley.ScoringAsh.Match do
    ...
    resource Volley.ScoringAsh.Event
  end

  def match_topic(%Volley.ScoringAsh.Match{id: id}), do: "match:#{id}"
end
