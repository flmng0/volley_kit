defmodule VolleyKitWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed w-80 sm:w-96 z-50 md:rounded-lg p-3 ring-1 flex flex-row md:flex-col",
        "md:top-2 md:right-2 md:mr-2",
        "max-md:bottom-2 max-md:left-1/2 max-md:-translate-x-1/2",
  ...
  attr :class, :string, default: nil
  attr :colors, :string, default: nil
  ...
  def button(assigns) do
    ...
    <button
      ...
      class={[
        ...
        @colors || "bg-zinc-900 hover:bg-zinc-700 text-white active:text-white/80",
        @class
      ]}
      {@rest}
    >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VolleyKitWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VolleyKitWeb.Gettext, "errors", msg, opts)
    end
  end
