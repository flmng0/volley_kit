defmodule VolleyWeb.Router do
  ...
  live_session :default,
    on_mount: [VolleyWeb.ClearFlash, {VolleyWeb.UserAuth, :mount_current_user}] do
    scope "/", VolleyWeb do
  ...
  scope "/", VolleyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{VolleyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", VolleyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{VolleyWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", VolleyWeb do
    ...
    live_session :current_user,
      on_mount: [{VolleyWeb.UserAuth, :mount_current_user}] do
